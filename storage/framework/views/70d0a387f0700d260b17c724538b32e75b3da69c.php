                ...
                enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="price_ar" type="text" class="form-control" name="price_ar" value="<?php echo e(old('price_ar')); ?>"
                                required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input id="price_after_discount" type="text" class="form-control" name="price_after_discount" value="<?php echo e(old('price_after_discount')); ?>"
                                required autofocus>
                        ...
                        <div class="form-group">
                            ...
                            <input id="price_after_discount_ar" type="text" class="form-control" name="price_after_discount_ar" value="<?php echo e(old('price_after_discount_ar')); ?>"
                                required autofocus>
