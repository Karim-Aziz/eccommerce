    ...
    <div class="all-services <?php if(App::isLocale('ar')): ?>  text-right  <?php endif; ?> ">
      <div class="container">
        <div class="row" data-aos="zoom-in" data-aos-duration="1500">
          <div class="col-md-12">
            <div class="show-ser">
              <form role="form" class="form-inline" action="<?php echo e(url('/pages/search')); ?>" method="get">
                <input class="form-control" placeholder="Search..." name="title" value="<?php echo e(old('title')); ?>" />
